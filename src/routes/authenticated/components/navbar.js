          ...
          <div className='user-drop-down'>
            <button className='user-drop-down-button'>
              <div className='display-flex'>
                <img width='35px' className='rounded' src={currentProfile.icon} alt="not found" />
            ...
            <ul className='user-drop-down-menu' style={{width: '200px'}}>
              <li className='user-drop-down-menu-item'>
                {profiles.map( (profile, index) => {
                  return (
                    <Link key={index} to='' className='display-flex margin-bottom'>
                      <img width='35px' className='rounded' src={profile.icon} alt="not found" />
                      {profile.name}
                    </Link>
                  )
                })}

                <Link to='/manage-profiles' className='display-flex'>
